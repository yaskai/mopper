...
mopper: raylib
ifneq (,$(mopper_config))
	@echo "==== Building mopper ($(mopper_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f mopper.make config=$(mopper_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f mopper.make clean
